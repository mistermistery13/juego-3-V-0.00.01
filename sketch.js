//sonidos
var S_1,S_2,S_3;
var E_1 = "apagado",E_2 = "apagado",E_3 = "apagado";
var C_1,C_2,C_3;
...
function preload(){
  ...
  S_3 = loadSound("./sonidos/musica3.mp3");
...
function setup(){
  ...
  C_3 = createSprite (650,height / 2,200,200);
  C_3.shapeColor = "black";
}
function draw(){
  background ("gray");
...
if (gameState === "musica"){
  ...
  if (mousePressedOver (C_3) && E_3 === "apagado"){
    cancion = S_3;
...
if (S_obstaculos >= 2 && S_obstaculos <= 4){
  if (frameCount % 30 === 0){
  var sierra_multicolor = createSprite (0 - 10,random (0,height),40,40);
  sierra_multicolor.addAnimation("multicolor",sierraMulticolor);
  sierra_multicolor.velocityX = 5;
  sierra_multicolor.lifetime = 300;
  sierra_multicolor.setCollider ("circle",0,0,5);
...
if (S_obstaculos >= 3 && S_obstaculos <= 4){
  if (frameCount % 30 === 0){
  var sierra_multicolor = createSprite (random (0,width) ,0 - 10,40,40);
  sierra_multicolor.addAnimation("multicolor",sierraMulticolor);
  sierra_multicolor.velocityY = 5;
  sierra_multicolor.lifetime = 300;
  sierra_multicolor.setCollider ("circle",0,0,5);
  //sierra_multicolor.debug= true;
...
if (S_obstaculos === 4){
  if (frameCount % 30 === 0){
  var sierra_multicolor = createSprite (random (0,width) ,height + 10,40,40);
  sierra_multicolor.addAnimation("multicolor",sierraMulticolor);
  sierra_multicolor.velocityY = -5;
  sierra_multicolor.lifetime = 300;
  sierra_multicolor.setCollider ("circle",0,0,5);
